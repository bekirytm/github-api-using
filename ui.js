                    ...
                    <div class="row">
                      ...
                      <div class="col-md-8">
                            ...
                            <li class="list-group">
                                ...
                                <li class="list-group-item borderzero">
                                    <img src="images/mail.png" title="Mail" width="30px">&nbsp; <span id="mail">${user.email}</span>
                                    
                                </li>
                                <li class="list-group-item borderzero">
                                    <img src="images/calendar.png" title="Son güncelleme tarihi" width="30px">&nbsp; <span id="mail">${tt}</span>
        ...
        repos.forEach(repo => {
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    &nbsp;&nbsp;
                    <button class="btn btn-info">
                        İzlenme :   <span class="badge badge-light" id ="repoFork">${repo.watchers}</span>
                    </button>            
                </div>
        </div>
